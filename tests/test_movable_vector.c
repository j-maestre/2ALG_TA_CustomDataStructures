...
int main() {
	...
	MVector *vector_1 = NULL;
	MVector *vector_2 = NULL;
	MVector *vector_3 = NULL;
	vector_1 = MVECTOR_create(kCapacityVector1);
	if (NULL == vector_1) {
		printf("\n create returned a null node in vector_1\n");
		return -1;
	}
	vector_2 = MVECTOR_create(kCapacityVector2);
	if (NULL == vector_2) {
		printf("\n create returned a null node in vector_2\n");
		return -1;
	}
	vector_3 = MVECTOR_create(kCapacityVector3);
	if (NULL == vector_3) {
